...
- [**mulch**](https://github.com/City-of-Memphis-Wastewater/mulch) — Pythonic Typer CLI for bootstrapping standard and templated workspaces. Controlled per-directory scaffolds using `.mulch/mulch.toml`. Stealth options available for directories shared between dev and non-dev folk.
